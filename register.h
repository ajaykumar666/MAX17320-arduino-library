...
enum StatusCode
{
    ...
    PowerOnReset = 0b0000000000000010,
    ...
    MinCurrentExceeded = 0b0000000000000100,
    ...
    MaxCurrentExceeded = 0b0000000001000000,
    ...
    Soc1PercentChange = 0b0000000010000000,
    ...
    MinVoltageExceeded = 0b0000000100000000,
    ...
    MinTemperatureExceeded = 0b0000001000000000,
    ...
    MinSocExceeded = 0b0000010000000000,
    ...
    MaxVoltageExceeded = 0b0001000000000000,
    ...
    MaxTemperatureExceeded = 0b0010000000000000,
    ...
    MaxSocExceeded = 0b0100000000000000,
    ...
    ProtectionAlert = 0b1000000000000000,
};
...
//    LeakageDetectionFault = 0b0000000000000001,
//    // Datasheet does not specify what this means
//    ResDFault = 0b0000000000000010,
//    // Overdischarge current (Discharging fault)
//    OverdischargeCurrent = 0b0000000000000100,
